...
const CACHE_NAME = 'globalvet-v29';
const PRECACHE_URLS = [
  './',
  './index.html',
  './manifest.json?v=globalvet-white-2',
  './globalvet-favicon-white.png',
  './globalvet-apple-touch-white.png',
  './globalvet-app-white-192.png',
  './globalvet-app-white-512.png',
